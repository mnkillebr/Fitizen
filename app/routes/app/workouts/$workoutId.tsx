...
function ExercisesPanel({ exerciseDetailsArray }: ExercisesPanelProps) {
  if (exerciseDetailsArray.length) {
    console.log(exerciseDetailsArray.sort((a, b) => a.orderInRoutine - b.orderInRoutine))
    return (
      <div className="flex flex-col gap-y-2 content-center max-h-[calc(100%-2.625rem)] snap-y snap-mandatory overflow-y-auto px-1 pb-1">
        {exerciseDetailsArray.sort((a, b) => a.orderInRoutine - b.orderInRoutine).map((exercise, idx) => {
          return (
            <div
              ...
              <>
                ...
                <AnimatePresence>
                  {open && (
                    ...
                    >
                      <Link to="edit" className="flex items-center gap-1 hover:bg-slate-200 hover:rounded-md p-1">
